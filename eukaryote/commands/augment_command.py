...
import eukaryote
from eukaryote.augment_args import AUGMENTATION_RECIPE_NAMES
...
class AugmentCommand(TextAttackCommand):
    ...
    def run(self, args):
        ...
        args = eukaryote.AugmenterArgs(**vars(args))
        if args.interactive:
    ...
    def register_subcommand(main_parser: ArgumentParser):
        ...
        parser = eukaryote.AugmenterArgs._add_parser_args(parser)
