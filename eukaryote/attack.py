...
from eukaryote.constraints import Constraint, PreTransformationConstraint
from eukaryote.goal_function_results import GoalFunctionResultStatus
from eukaryote.goal_functions import GoalFunction
from eukaryote.models.wrappers import ModelWrapper
from eukaryote.search_methods import SearchMethod
from eukaryote.shared import AttackedText, utils
from eukaryote.transformations import CompositeTransformation, Transformation
...
class Attack:
    ...
    def cuda_(self):
        ...
        def to_cuda(obj):
            visited.add(id(obj))
            if isinstance(obj, torch.nn.Module):
                obj.to(eukaryote.shared.utils.device)
            elif isinstance(
                obj,
                (
                    Attack,
