...
import eukaryote
from eukaryote.goal_functions import (
    InputReduction,
    MinimizeBleu,
...
def validate_model_gradient_word_swap_compatibility(model):
    ...
    """
    if isinstance(model, eukaryote.models.helpers.LSTMForClassification):
        return True
    else:
...
def transformation_consists_of(transformation, transformation_classes):
    ...
    from eukaryote.transformations import CompositeTransformation
...
def transformation_consists_of_word_swaps(transformation):
    ...
    swaps."""
    from eukaryote.transformations import WordSwap, WordSwapGradientBased
...
def transformation_consists_of_word_swaps_and_deletions(transformation):
    """Determines if ``transformation`` is a word swap or consists of only word
    swaps and deletions."""
    from eukaryote.transformations import WordDeletion, WordSwap, WordSwapGradientBased
