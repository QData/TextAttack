...
def load_textattack_model_from_path(model_name, model_path):
    ...
    if model_name.startswith("lstm"):
        ...
        model = eukaryote.models.helpers.LSTMForClassification(
        ...
        model = eukaryote.models.helpers.WordCNNForClassification(
            model_path=model_path, num_labels=num_labels
        )
    elif model_name.startswith("t5"):
        model = eukaryote.models.helpers.T5ForTextToText(model_path)
    else:
