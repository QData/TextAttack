...
from eukaryote.models.helpers import GloveEmbeddingLayer
from eukaryote.models.helpers.utils import load_cached_state_dict
...
class WordCNNForClassification(nn.Module):
    ...
    def __init__(
        ...
        self.tokenizer = eukaryote.models.tokenizers.GloveTokenizer(
