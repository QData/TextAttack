...
from eukaryote.constraints.semantics.sentence_encoders import UniversalSentenceEncoder
...
class SwapAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from eukaryote.transformations import WordInnerSwapRandom
...
class SynonymInsertionAugmenter(Augmenter):
    def __init__(self, **kwargs):
        from eukaryote.transformations import WordInsertionRandomSynonym
