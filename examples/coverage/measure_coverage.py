...
if args.attack != 'none':
	...
	pickle.dump( results_iterable , open( os.path.join(args.save_dir, "attack_results"), "wb" ) )
...
results_file.write('dataset, model, ratio, length, attack, limits, coverage, num_examples, num_test_examples, seed, split, coverage, num_successes, total\n')
