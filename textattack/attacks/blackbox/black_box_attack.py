...
class BlackBoxAttack(Attack):
    """ An abstract class that defines a black-box attack. 
        ...
        no other information about its parameters or internal state. We reduce 
        the model here to just the __call__ function so that black-box attacks 
        that extend this class can obtain prediction scores, but no other 
