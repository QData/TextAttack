...
Hard Label Attack Algorithm
=======================================
Uses the Hard Label Goal Function
...
from textattack.goal_functions import HardLabelClassification
...
class HardLabelAttack(AttackRecipe):
    ...
    def build(model_wrapper):
        ...
        #
        # Goal is hard label classification
        #
