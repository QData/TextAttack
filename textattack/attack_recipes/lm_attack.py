...
from textattack.transformations import WordSwapLanguageModel

def bert_recipe(model):
    #
    ...
    #
    transformation = WordSwapLanguageModel(max_candidates=30, textfooler_stopwords=True)
    #
