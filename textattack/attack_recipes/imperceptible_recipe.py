...
class ImperceptibleRecipe(AttackRecipe):
    ...
    @staticmethod
    def build(model_wrapper, goal_function_type: str = None, perturbation_type: str = None, perturbs=1, popsize=32, maxiter=10, **goal_function_kwargs):
        """
        ...
        Args:
            ...
            maxiter (int): Maximum number of generations for differential evolution.
        ...
        if goal_function_type is None:
            ...
            **goal_function_kwargs:
            - target_class: int = 0
            """
            goal_function = TargetedClassification(model_wrapper, **goal_function_kwargs) 
            ...
            **goal_function_kwargs:
            - target_class: int = 0
            """
            goal_function = TargetedStrict(model_wrapper, **goal_function_kwargs)
            ...
            **goal_function_kwargs:
            ...
            """
            goal_function = NamedEntityRecognition(model_wrapper, **goal_function_kwargs)
            ...
            **goal_function_kwargs:
            ...
            """
            goal_function = LogitSum(model_wrapper, **goal_function_kwargs)
            ...
            **goal_function_kwargs:
            ...
            """
            goal_function = MinimizeBleu(model_wrapper, **goal_function_kwargs)
            ...
            **goal_function_kwargs:
            ...
            """
            goal_function = MaximizeLevenshtein(model_wrapper, **goal_function_kwargs)
        else:
