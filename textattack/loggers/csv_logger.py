...
class CSVLogger(Logger):
    ...
    def log_attack_result(self, result):
        ...
        row = {'passage_1': s1, 'passage_2': s2, 'score_1': result.orig_score, 'score_2': result.perturbed_score, 'label_1': int(result.original_output), 'label_2': int(result.perturbed_output)} 
