...
class WordSwapDifferentialEvolution(WordSwap):
    """A base class for Word Swaps compatible with Differential Evolution
    search.
    ...
    def get_bounds_and_precomputed(
        self, current_text: AttackedText, max_perturbs: int
    ) -> Tuple[List[Tuple[int, int]], Optional[List[Any]]]:
        """Returns the bounds and optional precomputed values for differential
        evolution.
    ...
    def apply_perturbation(
        ...
        """Applies a perturbation to the input text based on a perturbation
        vector.
